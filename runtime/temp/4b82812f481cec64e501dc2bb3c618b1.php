<?php /*a:3:{s:60:"D:\PHPstudy\WWW\bike\application\admin\view\article\add.html";i:1541141849;s:59:"D:\PHPstudy\WWW\bike\application\admin\view\public\top.html";i:1540815845;s:60:"D:\PHPstudy\WWW\bike\application\admin\view\public\left.html";i:1540815912;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    ...
    <link href="/bike/public/static/admin/style/weather-icons.css" rel="stylesheet">

    <!--Beyond styles-->
    <link id="beyond-link" href="/bike/public/static/admin/style/beyond.css" rel="stylesheet" type="text/css">
    <link href="/bike/public/static/admin/style/demo.css" rel="stylesheet">
    <link href="/bike/public/static/admin/style/typicons.css" rel="stylesheet">
    <link href="/bike/public/static/admin/style/animate.css" rel="stylesheet">

    <script src="/bike/public/static/admin/ueditor/ueditor.config.js"></script>
    <script src="/bike/public/static/admin/ueditor/ueditor.all.min.js"></script>
    <script src="/bike/public/static/admin/ueditor/lang/zh-cn/zh-cn.js"></script>
        ...
        <div class="navbar-container">
            ...
            <div class="navbar-header pull-left">
                <a href="#" class="navbar-brand">
                    <small>
                        <!-- <img src="/bike/public/static/admin/images/logo.png"  alt=""> -->
                        后台管理系统
                    </small>
                </a>
            </div>
                    ...
                    <ul class="account-area">
                        <li>
                            ...
                            <ul class="pull-right dropdown-menu dropdown-arrow dropdown-login-area">
                                ...
                                <li class="dropdown-footer">
                                    <a href="<?php echo url('admin/edit',array('id'=>app('request')->session('id'))); ?>">
                                            修改密码
                                        </a>
                                </li>
                            </ul>
...
<div class="row">
        ...
        <div class="widget">
            ...
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="<?php echo url('article/add'); ?>" enctype="multipart/form-data" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select name="cateid" id="">
                                    ...
                                    <option value="<?php echo htmlentities($vo['id']); ?>"><?php if($vo['level'] != 0): ?>|<?php endif; ?>
                                        <?php echo str_repeat('-',$vo['level']*4)?><?php echo htmlentities($vo['catename']); ?></option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <textarea id="ueditor" required="" name="content"></textarea>
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
    ...
    <script type="text/javascript">    //实例化编辑器    //建议使用工厂方法getEditor创建和引用编辑器实例，如果在某个闭包下引用该编辑器，直接调用UE.getEditor('editor')就能拿到相关的实例    
    UE.getEditor('ueditor',{initialFrameWidth:800,initialFrameHeight:400,});    
    </script>
</body></html>